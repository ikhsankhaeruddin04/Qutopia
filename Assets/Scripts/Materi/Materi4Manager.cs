...
public class Materi4Manager : MonoBehaviour
{
    [System.Serializable]
    ...
    public string category = "Numbers and Things";
    public string videoFileName = "numbers.mp4"; // Harus ada di StreamingAssets
        ...
        yesButton.onClick.AddListener(() =>
{
    ...
    PlayerPrefs.SetString("Stage4Difficulty", "Adaptive");
    PlayerPrefs.Save();

    StartCoroutine(SendMateriResponse("Sudah"));
    SceneManager.LoadScene("IntroQuiz4");
});

noButton.onClick.AddListener(() =>
{
    PlayerPrefs.SetFloat("LastMastery", 0.3f);
    PlayerPrefs.SetString("Stage4Difficulty", "easy");
    PlayerPrefs.Save();

    StartCoroutine(SendMateriResponse("Belum"));
    SceneManager.LoadScene("Adv4");
});
