...
public class Materi3Manager : MonoBehaviour
{
    [System.Serializable]
    ...
    public string videoFileName = "school.mp4"; // Harus ada di StreamingAssets
    ...
    void Start()
    {
        ...
        yesButton.onClick.AddListener(() =>
        {
            ...
            SceneManager.LoadScene("IntroQuiz3");
        });
        ...
        noButton.onClick.AddListener(() =>
{
    ...
    // KUNCI STAGE 3 MULAI DARI EASY
    PlayerPrefs.SetString("Stage3Difficulty", "easy");

    PlayerPrefs.Save();

    StartCoroutine(SendMateriResponse("Belum"));
    SceneManager.LoadScene("Adv3");
});
