...
//     public string category = "Food and Drink";
//     public string videoFileName = "food.mp4"; // Harus ada di StreamingAssets
...
//             SceneManager.LoadScene("IntroQuiz");
//         });
...
public TMP_Text instructionText;
    ...
    public VideoPlayer videoPlayer;
    public string videoFileName = "food.mp4"; // StreamingAssets
    ...
    void UpdateNavigation()
{
    ...
    void SaveMastery(float mastery, string difficulty)
    {
        ...
        PlayerPrefs.SetString("Stage1Difficulty", difficulty);
        PlayerPrefs.Save();
    }
