...
public class Materi5Manager : MonoBehaviour
{
    [System.Serializable]
    ...
    public string category = "Days and Time";
    public string videoFileName = "days.mp4"; // Harus ada di StreamingAssets
       ...
       yesButton.onClick.AddListener(() =>
{
    ...
    PlayerPrefs.SetString("Stage5Difficulty", "Adaptive");
    PlayerPrefs.Save();

    StartCoroutine(SendMateriResponse("Sudah"));
    SceneManager.LoadScene("IntroQuiz5");
});

noButton.onClick.AddListener(() =>
{
    PlayerPrefs.SetFloat("LastMastery", 0.3f);
    PlayerPrefs.SetString("Stage5Difficulty", "easy");
    PlayerPrefs.Save();

    StartCoroutine(SendMateriResponse("Belum"));
    SceneManager.LoadScene("Adv5");
});
